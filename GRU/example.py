"""
This approach is written for TensorFlow support.
Ours is written in PyTorch but the example shown below
provides some intuitive guidance for prototyping a 
comparable topology in our own implementation.
"""
#!/usr/bin/env python3
# Original File gru_tensorflow.py from kmjjacobs
# Available at:
# https://gist.github.com/kmjjacobs/eab1e840aecf0ac232cc8370a9be9093
